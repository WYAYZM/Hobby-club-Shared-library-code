...
;本版本优化策略批处理基于百分浏览器版本 V5.0.1002.295适配

;本浏览器优化策略基于谷歌内核 V102.0.5005.167
...
>>"%Temp%\Reg2Temp.reg" echo [HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Policies\Google\Chrome\URLBlocklist];以下为阻止访问的网址
